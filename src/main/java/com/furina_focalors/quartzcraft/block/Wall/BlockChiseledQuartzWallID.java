...
public class BlockChiseledQuartzWallID extends Block
{
    ...
    public BlockChiseledQuartzWallID(String name, Material material, MapColor color, SoundType sound)
    {
        ...
        this.setRegistryName("chiseled_quartz_wall_id");
        this.setUnlocalizedName("chiseled_quartz_wall_id");
    }

    public BlockChiseledQuartzWallID(Material p_i46399_1_, MapColor p_i46399_2_) {
