...
public class BlockChiseledQuartzWallIG2 extends Block
{
    ...
    public BlockChiseledQuartzWallIG2(String name, Material material, MapColor color, SoundType sound)
    {
        ...
        this.setRegistryName("chiseled_quartz_wall_ig2");
        this.setUnlocalizedName("chiseled_quartz_wall_ig2");
    }

    public BlockChiseledQuartzWallIG2(Material p_i46399_1_, MapColor p_i46399_2_) {
