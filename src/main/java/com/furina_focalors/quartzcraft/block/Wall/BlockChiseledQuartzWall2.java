...
public class BlockChiseledQuartzWall2 extends Block
{
    ...
    public BlockChiseledQuartzWall2(String name, Material material, MapColor color, SoundType sound)
    {
        ...
        this.setRegistryName("chiseled_quartz_wall2");
        this.setUnlocalizedName("chiseled_quartz_wall2");
    }

    public BlockChiseledQuartzWall2(Material p_i46399_1_, MapColor p_i46399_2_) {
