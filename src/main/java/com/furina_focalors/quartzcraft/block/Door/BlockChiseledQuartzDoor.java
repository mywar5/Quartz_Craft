...
public class BlockChiseledQuartzDoor extends BlockDoor {
    public BlockChiseledQuartzDoor(String name, Material material, SoundType sound){
        super(Material.ROCK);
        this.setHardness(2.0F);
        this.setResistance(1F);
        this.setSoundType(SoundType.STONE);
        this.setCreativeTab(QuartzCraftCore.QuartzCraft_Tab);
        this.setRegistryName("chiseled_quartz_door");
        this.setUnlocalizedName("chiseled_quartz_door");
    }
