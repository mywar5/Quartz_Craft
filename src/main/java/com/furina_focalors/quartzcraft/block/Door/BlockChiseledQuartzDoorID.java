...
public class BlockChiseledQuartzDoorID extends BlockDoor {
    public BlockChiseledQuartzDoorID(String name, Material material, SoundType sound) {
        super(Material.ROCK);
        this.setHardness(2.5F);
        this.setResistance(1F);
        this.setSoundType(SoundType.STONE);
        this.setCreativeTab(QuartzCraftCore.QuartzCraft_Tab);
        this.setRegistryName("chiseled_quartz_door_id");
        this.setUnlocalizedName("chiseled_quartz_door_id");
    }
