...
public class BlockChiseledQuartzWallIS extends Block
{
    ...
    public BlockChiseledQuartzWallIS(String name, Material material, MapColor color, SoundType sound)
    {
        ...
        this.setRegistryName("chiseled_quartz_wall_is");
        this.setUnlocalizedName("chiseled_quartz_wall_is");
    }

    public BlockChiseledQuartzWallIS(Material p_i46399_1_, MapColor p_i46399_2_) {
