...
public class BlockChiseledQuartzWallID2 extends Block
{
    ...
    public BlockChiseledQuartzWallID2(String name, Material material, MapColor color, SoundType sound)
    {
        ...
        this.setRegistryName("chiseled_quartz_wall_id2");
        this.setUnlocalizedName("chiseled_quartz_wall_id2");
    }

    public BlockChiseledQuartzWallID2(Material p_i46399_1_, MapColor p_i46399_2_) {
