...
public class BlockChiseledQuartzWallIG extends Block
{
    ...
    public BlockChiseledQuartzWallIG(String name, Material material, MapColor color, SoundType sound)
    {
        ...
        this.setRegistryName("chiseled_quartz_wall_ig");
        this.setUnlocalizedName("chiseled_quartz_wall_ig");
    }

    public BlockChiseledQuartzWallIG(Material p_i46399_1_, MapColor p_i46399_2_) {
