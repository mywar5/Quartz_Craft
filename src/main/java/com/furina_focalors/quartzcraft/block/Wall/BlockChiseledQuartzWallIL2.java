...
public class BlockChiseledQuartzWallIL2 extends Block
{
    ...
    public BlockChiseledQuartzWallIL2(String name, Material material, MapColor color, SoundType sound)
    {
        ...
        this.setRegistryName("chiseled_quartz_wall_il2");
        this.setUnlocalizedName("chiseled_quartz_wall_il2");
    }

    public BlockChiseledQuartzWallIL2(Material p_i46399_1_, MapColor p_i46399_2_) {
