...
public class BlockChiseledQuartzWallIS2 extends Block
{
    ...
    public BlockChiseledQuartzWallIS2(String name, Material material, MapColor color, SoundType sound)
    {
        ...
        this.setRegistryName("chiseled_quartz_wall_is2");
        this.setUnlocalizedName("chiseled_quartz_wall_is2");
    }

    public BlockChiseledQuartzWallIS2(Material p_i46399_1_, MapColor p_i46399_2_) {
