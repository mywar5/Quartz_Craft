...
public class BlockQuartzWall2 extends Block
{
    ...
    public BlockQuartzWall2(String name, Material material, MapColor color, SoundType sound)
    {
        ...
        this.setRegistryName("quartz_wall2");
        this.setUnlocalizedName("quartz_wall2");
    }

    public BlockQuartzWall2(Material p_i46399_1_, MapColor p_i46399_2_) {
