...
public class BlockQuartzDoor extends BlockDoor {
    protected BlockQuartzDoor(String name, Material material, SoundType sound) {
        super(Material.ROCK);
        this.setHardness(2.0F);
        this.setResistance(1F);
        this.setSoundType(SoundType.STONE);
        this.setCreativeTab(QuartzCraftCore.QuartzCraft_Tab);
        this.setRegistryName("quartz_door");
        this.setUnlocalizedName("quartz_door");
    }
