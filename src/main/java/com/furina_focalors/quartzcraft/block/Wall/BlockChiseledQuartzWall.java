...
public class BlockChiseledQuartzWall extends Block
{
    ...
    public BlockChiseledQuartzWall(String name, Material material, MapColor color, SoundType sound)
    {
        ...
        this.setRegistryName("chiseled_quartz_wall");
        this.setUnlocalizedName("chiseled_quartz_wall");
    }

    public BlockChiseledQuartzWall(Material p_i46399_1_, MapColor p_i46399_2_) {
