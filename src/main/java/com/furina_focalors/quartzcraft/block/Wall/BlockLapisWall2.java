...
public class BlockLapisWall2 extends Block
{
    ...
    public BlockLapisWall2(String name, Material material, MapColor color, SoundType sound)
    {
        ...
        this.setRegistryName("lapis_wall2");
        this.setUnlocalizedName("lapis_wall2");
    }

    public BlockLapisWall2(Material p_i46399_1_, MapColor p_i46399_2_) {
