...
public class BlockLapisWall extends Block
{
    ...
    public BlockLapisWall(String name, Material material, MapColor color, SoundType sound)
    {
        ...
        this.setRegistryName("lapis_wall");
        this.setUnlocalizedName("lapis_wall");
    }

    public BlockLapisWall(Material p_i46399_1_, MapColor p_i46399_2_) {
