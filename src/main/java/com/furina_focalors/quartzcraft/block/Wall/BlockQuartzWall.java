...
public class BlockQuartzWall extends Block
{
    ...
    public BlockQuartzWall(String name, Material material, MapColor color, SoundType sound)
    {
        ...
        this.setRegistryName("quartz_wall");
        this.setUnlocalizedName("quartz_wall");
    }

    public BlockQuartzWall(Material p_i46399_1_, MapColor p_i46399_2_) {
