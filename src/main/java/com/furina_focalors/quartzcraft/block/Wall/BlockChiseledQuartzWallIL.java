...
public class BlockChiseledQuartzWallIL extends Block
{
    ...
    public BlockChiseledQuartzWallIL(String name, Material material, MapColor color, SoundType sound)
    {
        ...
        this.setRegistryName("chiseled_quartz_wall_il");
        this.setUnlocalizedName("chiseled_quartz_wall_il");
    }

    public BlockChiseledQuartzWallIL(Material p_i46399_1_, MapColor p_i46399_2_) {
